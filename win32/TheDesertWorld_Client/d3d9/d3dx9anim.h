...
//  ppFrameHierarchy
//      Returns ***REMOVED*** node pointer of the loaded frame hierarchy
//  ppAnimController
...
// D3DXFrameDestroy:
// -----------------
// Destroys the subtree of frames under the ***REMOVED***, including the ***REMOVED***
//
// Parameters:
//	pFrameRoot
...
// Parameters:
//	pFrameRoot
//		Pointer to the ***REMOVED*** node of the subtree
// Return Value:
//		Count of frames
//
//----------------------------------------------------------------------------

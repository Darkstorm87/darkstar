...
COFFER_MIN_ILLUSION_TIME = 60;  -- 1 minutes
CHEST_MAX_ILLUSION_TIME  = 120;  -- 2 minutes
CHEST_MIN_ILLUSION_TIME  = 60;  -- 1 minutes
...
-- DYNAMIS SETTINGS
    ...
    TIMELESS_HOURGLASS_COST = 10000;   -- cost of the timeless hourglass for Dynamis.
...
-- FIELDS OF VALOR/Grounds of Valor SETTINGS
REGIME_WAIT = 1; --Make people wait till 00:00 game time as in retail. If it's 0, there is no wait time.
FIELD_MANUALS = 0; -- Enables Fields of Valor manuals
LOW_LEVEL_REGIME = 0; --Allow people to kill regime targets even if they give no exp, allowing people to farm regime targets at 75 in low level areas.

...
function onEffectGain(target,effect)
    ...
    target:addPetMod(dsp.mod.HP, 45)
    target:addPetMod(dsp.mod.MP, 25)
    target:addPetMod(dsp.mod.STR, 7)
    target:addPetMod(dsp.mod.DEX, 8)
    target:addPetMod(dsp.mod.MND, -4)
    target:addPetMod(dsp.mod.CHR, 7)
    target:addPetMod(dsp.mod.FOOD_ACCP, 11)
    target:addPetMod(dsp.mod.FOOD_ACC_CAP, 105)
    target:addPetMod(dsp.mod.FOOD_RACCP, 11)
    target:addPetMod(dsp.mod.FOOD_RACC_CAP, 105)
...
function onEffectLose(target, effect)
    ...
    target:delPetMod(dsp.mod.HP, 45)
    target:delPetMod(dsp.mod.MP, 25)
    target:delPetMod(dsp.mod.STR, 7)
    target:delPetMod(dsp.mod.DEX, 8)
    target:delPetMod(dsp.mod.MND, -4)
    target:delPetMod(dsp.mod.CHR, 7)
    target:delPetMod(dsp.mod.FOOD_ACCP, 11)
    target:delPetMod(dsp.mod.FOOD_ACC_CAP, 105)
    target:delPetMod(dsp.mod.FOOD_RACCP, 11)
    target:delPetMod(dsp.mod.FOOD_RACC_CAP, 105)

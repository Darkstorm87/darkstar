...
function onEffectGain(target, effect)
    ...
    target:addPetMod(dsp.mod.DEX, 3)
    target:addPetMod(dsp.mod.AGI, 3)
    target:addPetMod(dsp.mod.MND, -1)
    target:addPetMod(dsp.mod.FOOD_ACCP, 20)
    target:addPetMod(dsp.mod.FOOD_ACC_CAP, 18)
    target:addPetMod(dsp.mod.FOOD_RACCP, 20)
    target:addPetMod(dsp.mod.FOOD_RACC_CAP, 18)
    target:addPetMod(dsp.mod.DOUBLE_ATTACK, 1)
end
...
function onEffectLose(target, effect)
    ...
    target:delPetMod(dsp.mod.DEX, 3)
    target:delPetMod(dsp.mod.AGI, 3)
    target:delPetMod(dsp.mod.MND, -1)
    target:delPetMod(dsp.mod.FOOD_ACCP, 20)
    target:delPetMod(dsp.mod.FOOD_ACC_CAP, 18)
    target:delPetMod(dsp.mod.FOOD_RACCP, 20)
    target:delPetMod(dsp.mod.FOOD_RACC_CAP, 18)
    target:delPetMod(dsp.mod.DOUBLE_ATTACK, 1)
end

...
function onSpellCast(caster,target,spell)
    ...
    if (target:getAllegiance() == caster:getAllegiance() and (target:getObjType() == dsp.objType.PC or target:getObjType() == dsp.objType.MOB or target:getObjType() == dsp.objType.PET)) then
        if (USE_OLD_CURE_FORMULA == true) then

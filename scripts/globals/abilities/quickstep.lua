        ...
        if mjob == dsp.job.DNC then
            if (target:hasStatusEffect(dsp.effect.LETHARGIC_DAZE_1)) then
                ...
                if (player:hasStatusEffect(dsp.effect.PRESTO)) then
                    target:addStatusEffect(dsp.effect.LETHARGIC_DAZE_3,1,0,duration+45)
                    daze = 3
                    effect = 3
                else
                    target:addStatusEffect(dsp.effect.LETHARGIC_DAZE_2,1,0,duration+45)
                    daze = 2
                    effect = 2
                end
            ...
            elseif (target:hasStatusEffect(dsp.effect.LETHARGIC_DAZE_2)) then
                ...
                if (player:hasStatusEffect(dsp.effect.PRESTO)) then
                    target:addStatusEffect(dsp.effect.LETHARGIC_DAZE_4,1,0,duration+45)
                    daze = 3
                    effect = 4
                else
                    target:addStatusEffect(dsp.effect.LETHARGIC_DAZE_3,1,0,duration+45)
            ...
            elseif (target:hasStatusEffect(dsp.effect.LETHARGIC_DAZE_3)) then
                ...
                if (player:hasStatusEffect(dsp.effect.PRESTO)) then
                    target:addStatusEffect(dsp.effect.LETHARGIC_DAZE_5,1,0,duration+45)
                    daze = 3
                    effect = 5
                else
                    target:addStatusEffect(dsp.effect.LETHARGIC_DAZE_4,1,0,duration+45)

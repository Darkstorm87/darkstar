...
function onTrade(player,npc,trade)
    ...
    elseif (player:getQuestStatus(WINDURST,dsp.quests.ids.windurst.THE_ROOT_OF_THE_PROBLEM) == QUEST_ACCEPTED and player:getVar("***REMOVED***Problem") == 1) then
...
function onTrigger(player,npc)
    ...
    local ***REMOVED***Problem = player:getQuestStatus(WINDURST,dsp.quests.ids.windurst.THE_ROOT_OF_THE_PROBLEM);
    ...
    elseif (recollections == QUEST_COMPLETED and ***REMOVED***Problem == QUEST_AVAILABLE and mJob == dsp.job.BLM and mLvl >= 50 and player:needToZone() == false) then
            player:startEvent(276,0,829); -- Start Quest "The Root of The problem"
    elseif (***REMOVED***Problem == QUEST_ACCEPTED) then
        if (player:getVar("***REMOVED***Problem") == 1) then
            player:startEvent(277,0,829);
        elseif (player:getVar("***REMOVED***Problem") == 2) then
...
function onEventFinish(player,csid,option)
    ...
    elseif (csid == 276) then
        ...
        player:setVar("***REMOVED***Problem",1);

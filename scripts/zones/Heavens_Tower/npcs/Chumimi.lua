...
function onTrade(player,npc,trade)
    ...
    elseif (player:getQuestStatus(WINDURST,dsp.quest.id.windurst.THE_ROOT_OF_THE_PROBLEM) == QUEST_ACCEPTED and player:getCharVar("***REMOVED***Problem") == 1) then
...
function onTrigger(player,npc)
    ...
    elseif (***REMOVED***Problem == QUEST_ACCEPTED) then
        if (player:getCharVar("***REMOVED***Problem") == 1) then
            player:startEvent(277,0,829);
        elseif (player:getCharVar("***REMOVED***Problem") == 2) then

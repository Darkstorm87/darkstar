...
function onTrade(player,npc,trade)
	...
	elseif (player:getQuestStatus(WINDURST,THE_ROOT_OF_THE_PROBLEM) == QUEST_ACCEPTED and player:getVar("***REMOVED***Problem") == 1) then
...
function onTrigger(player,npc)
	...
	***REMOVED***Problem = player:getQuestStatus(WINDURST,THE_ROOT_OF_THE_PROBLEM);
	...
	elseif(***REMOVED***Problem == QUEST_AVAILABLE and mJob == 4 and mLvl >= 50 and player:needToZone() == false) then

...
"C:\Program Files\MySQL\MySQL Server 5.7\bin\mysqldump" -u ***REMOVED*** -p***REMOVED*** dspdb char_points > .\char_points.sql
...
"C:\Program Files\MySQL\MySQL Server 5.7\bin\mysqldump" -u ***REMOVED*** -p***REMOVED*** dspdb char_spells > .\char_spells.sql
...
"C:\Program Files\MySQL\MySQL Server 5.7\bin\mysqldump" -u ***REMOVED*** -p***REMOVED*** dspdb > .\dspdb.sql
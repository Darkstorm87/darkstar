...
"C:\Program Files\MySQL\MySQL Server 5.7\bin\mysqldump" -u root -pHokuten1 dspdb char_points > .\.sql
...
"C:\Program Files\MySQL\MySQL Server 5.7\bin\mysqldump" -u root -pHokuten1 dspdb char_spells > .\.sql

...
"C:\Program Files\MySQL\MySQL Server 5.7\bin\mysqladmin" -h localhost -u root -pHokuten1 DROP dspdb

ECHO Creating Database dspdb
"c:\program files\mysql\mysql server 5.7\bin\mysqladmin" -h localhost -u root -pHokuten1 CREATE dspdb

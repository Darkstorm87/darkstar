...
REM ====== then change '-p***REMOVED***' to '-pfoo' (3 places).             =========
REM ======                                                              =========
...
REM "c:\program files\mysql\mysql server 5.6\bin\mysqladmin" -h localhost -u ***REMOVED*** -p***REMOVED*** DROP dspdb

REM ECHO Creating Database dspdb
REM "c:\program files\mysql\mysql server 5.6\bin\mysqladmin" -h localhost -u ***REMOVED*** -p***REMOVED*** CREATE dspdb

ECHO Loading dspdb tables into the database
cd D:\FFXI\darkstar\sql
FOR %%X IN (*.sql) DO ECHO Importing %%X & "c:\program files\mysql\mysql server 5.6\bin\mysql" dspdb -h localhost -u ***REMOVED*** -p***REMOVED*** < %%X

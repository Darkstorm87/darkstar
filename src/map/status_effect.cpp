...
CStatusEffect::CStatusEffect(EFFECT id, uint16 icon, uint32 power, uint32 tick, uint32 duration, uint32 subid, uint32 subPower, uint16 tier, uint32 flags) :
